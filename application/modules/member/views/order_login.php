...
<div class="container">
    <div class="card card-container">
        ...
        <form class="form-signin" id="login" method="post">
            <input type="hidden" id="Id" name="Id" value="<? echo $detail->ProductId ?>">
            ...
            <button class="btn btn-lg btn-primary btn-block btn-signin" id="sign" type="submit">Sign in</button>
        </form><!-- /form -->
        <a href="#" class="forgot-password" onclick="document.location.replace('<? echo base_url();?>member/register/');">
            Register
        </a>
    </div><!-- /card-container -->
</div><!-- /container -->
